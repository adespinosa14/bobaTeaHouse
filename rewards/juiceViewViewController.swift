...
class juiceViewViewController: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        let newID = UserDefaults.standard.object(forKey: "juiceId") as! String
        print(newID)
